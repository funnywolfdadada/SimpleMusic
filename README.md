# SimpleMusic
  ...
  暂未实现对耳机插拔和音乐焦点事件的处理。
![test image size](/SimpleMusicScreenshot1.jpg){:class="img-responsive"}
![test image size](/SimpleMusicScreenshot1.jpg){:height="30%" width="30%"}
![test image size](/SimpleMusicScreenshot1.jpg){:height="100px" width="400px"}
