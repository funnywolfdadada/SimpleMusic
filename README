# SimpleMusic
  ...
  暂未实现对耳机插拔和音乐焦点事件的处理。
![](/SimpleMusicScreenshot1.jpg "截图1")
![](https://github.com/funnywolfdadada/SimpleMusic/master/SimpleMusicScreenshot2.jpg "截图2")
![](https://github.com/funnywolfdadada/SimpleMusic/master/SimpleMusicScreenshot3.jpg "截图3")
